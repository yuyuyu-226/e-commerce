...
const ProductCard = ({ product }) => {
    ...
    return (
        ...
        maximumFractionDigits: 2, }) : "N/A"}
                    ...
                    <button 
                        // The 'Add to Cart' button should also use soft navigation/logic if it were a link
                        onClick={handleClick}
        ...
        return (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-8">
                {products.map(product => (
                    // ProductCard now uses the stable navigate hook
    ...
    return (
        ...
        <div className="min-h-screen flex font-inter" style={{ backgroundColor: 'var(--color-light-accent)' }}>
            ...
            >
                ...
                {/* Search Bar */}
                <div className="mb-6 pb-4 border-b" style={{ borderColor: 'var(--color-primary-dark)' }}>
