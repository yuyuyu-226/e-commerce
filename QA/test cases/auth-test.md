...
|---------------|------------------------------------------------|---------------------------------------------------|---------------------------------------------------------|-------------|---------|-------|
| AUTH-01       | Verify user can sign up with valid credentials | Go to Sign-Up page → Enter valid details → Submit | Account is created and confirmation email sent | Complete |  Partial | Account created successfully but no confirmation email is sent |
